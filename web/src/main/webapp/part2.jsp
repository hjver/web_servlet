...
<body>
<form id="frm" method="post" action="http://172.30.1.95:8080/web/part3.do" enctype="multipart/form-data">
<p>회원가입 정보 입력[간편가입]</p>
아이디 : <input type="text" name="mid"><br>
고객명 : <input type="text" name="mname"><br>
비밀번호 : <input type="password" name="mpass" maxlength="12">* 비밀번호 최소 6~12자리 입니다.<br>
이메일 : <input type="text" name="memail"><br>
휴대폰번호 : <input type="text" name="mtel" maxlength="12">* "-"는 입력하지 않습니다.<br>
이미지 : <input type="file" name="mfile">* 이미지 첨부는 최대 2MB 이하 입니다.<br>
<button type="button" value="" onclick="gopage()">가입완료</button>
</form>
<script>
function gopage(){
	if(frm.mid.value==""){
